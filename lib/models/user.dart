...
class User {
  ...
  final String name;
  final String email;
  final List<ParticipationHistory> participationHistory;
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      participationHistory: (json['participationHistory'] as List)
          .map((history) => ParticipationHistory.fromJson(history))
          .toList(),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'name': name,
      'email': email,
      'participationHistory': participationHistory.map((h) => h.toJson()).toList(),
    };
  }
}
